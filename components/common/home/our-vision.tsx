        ...
        <div className="mb-12 grid gap-8 md:grid-cols-2 md:gap-12">
          <div className="lg:space-y-6">
            ...
            <p className="p1 text-[#1a2e05]">
              &quot; <span className='text-[#84cc16]'>বাংলাদেশ ২.০</span> &quot; আমাদের জন্য আশার প্রতীক। এটি স্বৈরাচার শাসক থেকে মুক্তি এবং উজ্জ্বল ভবিষ্যতের স্বপ্ন দেখার সাহস এনে দিয়েছিল। যদিও এটি সমস্যা চিহ্নিত করতে সফল ছিল, স্পষ্ট দিকনির্দেশনার অভাব ছিল। তবুও এটি ভিন্নভাবে চিন্তা করার সাহস জুগিয়েছে এবং বড় স্বপ্ন দেখার সুযোগ তৈরি করেছে।
            </p>
          </div>
