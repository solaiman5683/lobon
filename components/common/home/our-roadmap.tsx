...
{
    return (
        <div className="bg-[#F3E9F4] py-32">
            <div className="container space-y-5">
                <h2 className="text-[#0A221F] text-5xl font-medium leading-[55px]">আমাদের রোডম্যাপ</h2>
                <p className="max-w-xl text-xl font-medium font-noto-sans leading-normal text-[#0A221F]">
                ...
                <Image src="/images/roadmap.svg" width={1200} height={3355} alt="Next Gen" priority className="h-auto w-full pt-8 pointer-events-none" />
