    ...
    <div className='bg-[#fce7f3] py-36'>
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex gap-10 my-[50px]">
          <div className="min-w-max w-[600px]">
            <Image src="/images/governance-logo.svg" width={600} height={880} alt="Our Governance" className="h-auto" />
          </div>
          ...
          <div className="flex-1 flex flex-col justify-between space-y-3">
            ...
            <div className="bg-[#434C39] rounded-xl p-8 flex flex-col items-center w-full">
              <Image src="/icons/donate-credit.svg" width={48} height={48} alt="Our Governance" />
            ...
            <div className="bg-[#434C39] rounded-xl p-8 flex flex-col items-center w-full">
              <Image src="/icons/lifetime-credit.svg" width={48} height={48} alt="Our Governance" />
              <h4 className="text-center justify-start text-white text-2xl font-semibold leading-loose">Lifetime Credit</h4>
              <p className="max-w-72 text-center justify-start text-white text-base font-medium leading-normal">
