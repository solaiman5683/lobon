...
export const JoinUs = () => <div>
    <div className="max-w-[515px] mx-auto text-center justify-start text-lime-950 text-xl font-medium font-sl leading-loose">আপনার যদি কোনো প্রশ্ন থাকে, তাহলে নির্দ্বিধায় আমাদের কমিউনিটিতে জিজ্ঞাসা করতে পারেন।</div>
